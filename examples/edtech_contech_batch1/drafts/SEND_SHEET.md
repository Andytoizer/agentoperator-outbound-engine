...
They use Freckle to pull contractor lists from Google Maps - "general contractors in louisiana", "commercial builder tampa" - classify each as residential vs commercial vs sub, and enrich with owner + PM + superintendent + safety lead contacts. One recent engine: 875 companies → 566 decision makers + 505 LinkedIn profiles + 505 emails + 404 phone numbers, all synced to HubSpot.
...
**LI 1/2:** Hey [First6] - I helped set up a Google Places → HubSpot contractor enrichment engine for BuildPass (875 companies → 566 decision makers + 505 emails + HubSpot sync). Same engine should map cleanly to BuildOps' commercial sub ICP. Worth connecting?
